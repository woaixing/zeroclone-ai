...
| aigc降重 | 文本/文档，支持多检测平台 |
| 格式排版 | 上传模板、一键排版 |
| AIGC率检测 | AIGC率检测功能生成PDF报告 |
| 营销活动 | 邀请奖励、评论奖励、分享奖励、盲盒抽奖 |
| 套餐购买 | 字数包、时长包在线购买 |
| 卡密兑换 | 支持卡密激活充值 |
| 微信支付 | 扫码支付，快速到账 |
| 推广分销 | 邀请好友赚取佣金 |
...
### 用户界面
![C端首页](images/用户端/1.png)
![C端格式](images/用户端/格式1.png)
![C端格式](images/用户端/格式2.png)
![C端AIGC检测](images/用户端/检测.png)
![C端活动中心](images/用户端/邀请有奖.png)
![C端活动中心](images/用户端/抽奖.png)
![C端套餐](images/用户端/商城.png)
